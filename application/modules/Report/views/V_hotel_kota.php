        ...
        <div class="card">
            <div class="card-header card-header-tabs card-header-rose">
                <div class="nav-tabs-navigation">
                    ...
                    <h3 class="float-left" style="margin-top: -1px;">List Hotel</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content tab-space">
                    ...
                    <div class="container-fluid mt-3">
                        <table id="tabel_hotel" class="table table-light table-bordered table-hover table-striped" width="100%">
    ...
    <div class="tab-pane" id="menu2">
        <div class="card">
            <div class="card-header card-header-tabs card-header-rose">
                <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                        <h3 class="float-left" style="margin-top: -1px;">Detail Kota Hotel</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin: 5px;">
                            <div class="col-md-4 offset-md-2">
                                <div class="row">
                                    <label class="col-sm-4 text-dark mt-1">Nama Hotel</label>
                                    <div class="col-sm-8">
                                        <h6 class="font-weight-bold mt-1" id="label_hotel"></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control datepicker12" id="periode_kota" data="1" name="periode" style="margin-top: -6px;" placeholder="Pilih Bulan" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="tab-pane active" id="link1">
                    <div class="container-fluid mt-3">
                        <table id="tbl_wisnus_kota" class="table table-light table-bordered table-hover table-striped" width="100%">
                            <thead class="thead-light">
                ...
                <div class="tab-pane" id="link2">
                    <div class="container-fluid mt-3">
                    <table id="tbl_wisman_kota" class="table table-light table-bordered table-hover table-striped" width="100%">
                        <thead class="thead-light">
                        <th class="text-center" width="30px;">No</th>
...
<script src="<?php echo base_url('assets/js/') ?>ajax/report/hotel.js"></script>
