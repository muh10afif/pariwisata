        ...
        <div class="card">
            <div class="card-header card-header-tabs card-header-rose">
                <div class="nav-tabs-navigation">
                    ...
                    <h3 class="float-left" style="margin-top: -1px;">List Dtw</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content tab-space">
                    ...
                    <div class="container-fluid mt-3">
                        <table id="tabel_dtw" class="table table-light table-bordered table-hover table-striped" width="100%">
    ...
    <div class="tab-pane" id="menu2">
        <div class="card">
            <div class="card-header card-header-tabs card-header-rose">
                <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                        <h3 class="float-left" style="margin-top: -1px;">Detail Kota DTW</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin: 5px;">
                            <div class="col-md-4 offset-md-2">
                                <div class="row">
                                    <label class="col-sm-4 text-dark mt-1">Nama DTW</label>
                                    <div class="col-sm-8">
