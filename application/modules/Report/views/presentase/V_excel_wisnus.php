...
<h5 style="font-weight: bold;">Perbandingan Wisatawan Nusantara</h5>
...
<table border="1" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <th class="text-right"><?= $lainnya_prov[0]['m_on_m'] ?></th>
            <th class="text-right"><?= $lainnya_prov[0]['y_on_y'] ?></th>
        </tr>
        ...
        <tr>
            ...
            <th class="text-right"><?= $m_on_m + $lainnya_prov[0]['m_on_m'] ?></th>
            <th class="text-right"><?= $y_on_y + $lainnya_prov[0]['y_on_y'] ?></th>
        </tr>
    </tbody>
</table>
