...
<html>
    ...
    <body>
      ...
      <h5>Report DTW <br> <?= nice_date($tgl_awal, 'd-F-Y') ?> s/d <?= nice_date($tgl_akhir, 'd-F-Y') ?></h5>
      <br>
      <?php 
      ...
      <table border="1" id="ad" width="100%">
        ...
        <tbody>
            <?php foreach ($dtw as $d): ?>
                <tr>
                    ...
                    <?php $tot_wisnus = $this->M_report->get_tot_dtw_wisnus_wisman('wisnus', $from, $d['id_dtw'], $id_kota)->row_array(); 
                    ...
                    <?php $tot_wisman = $this->M_report->get_tot_dtw_wisnus_wisman('wisman', $from, $d['id_dtw'], $id_kota)->row_array(); 
        ...
        <tfoot>
            <tr>
                ...
                <?php $tot_wisnus = $this->M_report->get_tot_dtw_wisnus_wisman('wisnus', $from, $id_dtw = '', $id_kota)->row_array(); 
                ...
                <?php $tot_wisman = $this->M_report->get_tot_dtw_wisnus_wisman('wisman', $from, $id_dtw = '', $id_kota)->row_array(); 
