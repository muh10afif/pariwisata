    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive mt-3">
                <table id="tabel_kota_hotel" class="table table-light table-striped table-hover table-bordered" width="100%">
    ...
    <form method="POST" action="<?php echo base_url()?>/Master/Hotel/import" enctype="multipart/form-data">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Import Data Akomodasi</h5>
