    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <?php if ($id_sess_kota == 0) : ?>
                <a href="<?= base_url('Master/Hotel') ?>" class="btn btn-warning btn-fab btn-round ml-5" style="margin-top:-20px;z-index:9" rel="tooltip" data-original-title="Kembali"><i class="material-icons text-white">chevron_left</i></a>
            <?php endif; ?>

            <div class="card-body table-responsive">

            <form id="form-hotel" class="p-20" autocomplete="off">
...
<script src="<?php echo base_url('assets/js/') ?>ajax/master/master_hotel.js"></script>