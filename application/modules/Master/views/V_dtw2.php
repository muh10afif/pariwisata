...
<div class="nav-tabs-wrapper">
  <h3 class="float-left" style="margin-top: -1px;">Tabel Master DTW</h3>
</div>
</div>
...
<div class="tab-content tab-space">
  <div class="tab-pane active" id="link1">
    <table id="tbl_dtw" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width: 100%;" role="grid">
      ...
      <div class="modal-body">
        <form>
          <input type="hidden" id="id2">
            <div class="form-group">
            <input type="text" class="form-control" id="dtw2" placeholder="Nama DTW">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="number" class="form-control" id="lat2" placeholder="Latitude">
          </div>
          <div class="form-group">
          <input type="number" class="form-control" id="long2" placeholder="Longitude">  
          </div>
          <div class="form-group">
          <input type="email" class="form-control" id="email2" placeholder="Email">  
          </div>
          <div class="form-group">
          <input type="number" class="form-control" id="no_hp2" placeholder="No HP">  
          </div>
          <div class="form-group">
