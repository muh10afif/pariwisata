        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_dtw" width="40" height="10"></canvas>
                </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_dtw_wisnus" width="40" height="15"></canvas>
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_dtw_wisman" width="40" height="15"></canvas>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_hotel" width="40" height="10"></canvas>
                </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_hotel_wisnus" width="40" height="15"></canvas>
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <canvas id="myChart_hotel_wisman" width="40" height="15"></canvas>
                </div>
...
<script>
    ...
    var dtw             = document.getElementById('myChart_dtw').getContext('2d');
    ...
    var hotel           = document.getElementById('myChart_hotel').getContext('2d');
    var hotel_wisnus    = document.getElementById('myChart_hotel_wisnus').getContext('2d');
    var hotel_wisman    = document.getElementById('myChart_hotel_wisman').getContext('2d');
