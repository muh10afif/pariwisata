    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose">
                <h3 class="card-title">User Akomodasi</h3>
                
            </div>
            <div class="card-body table-responsive mt-3">
                <table id="tabel_user_hotel" class="table table-light table-striped table-hover table-bordered" width="100%">
                    <thead class="thead-light">
                        <tr>
                            <th>No.</th>
                            <th>Kota / Kabupaten</th>
                            <th>Jumlah Akomodasi</th>
                            <th>Jumlah Aktif User</th>
                            <th width='15%'>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
