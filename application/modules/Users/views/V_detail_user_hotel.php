    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose">
                <h3 class="card-title mb-3" id="judul">List Hotel, <?= ucwords($nama_kota) ?></h3>
            </div>

            <?php if ($id_sess_kota == 0) : ?>
                <a href="<?= base_url('Users/Hotel') ?>" class="btn btn-warning btn-fab btn-round ml-5" style="margin-top:-20px;z-index:9" rel="tooltip" data-original-title="Kembali"><i class="material-icons text-white">chevron_left</i></a>
            <?php endif; ?>

            <div class="card-body table-responsive">

            <form id="form-hotel" class="p-20" autocomplete="off" <?= (count($hotel) == 0) ? 'hidden' : '' ?>>
                ...
                <div class="row mt-3" style="margin: 10px;">
                    <div class="col-md-4">
                        <div class="row">
                            <label class="col-sm-3 text-dark mt-2">Hotel</label>
                            <div class="col-sm-9">
                                <select class="form-control sel2" name="hotel" id="hotel">
                                        <option value=" ">-- Pilih Hotel --</option>
                                    <?php foreach ($hotel as $k): ?>
                                        <option value="<?= $k['id_hotel'] ?>"><?= $k['nama_hotel'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-end mt-3" style="margin: 10px;">
                    ...
                    <button class="btn btn-sm btn-primary mt-3" id="simpan_hotel" type="button">Simpan</button>
                </div>
