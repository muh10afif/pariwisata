        ...
        <div class="card-header card-header-tabs card-header-rose">
          <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
              <h3 class="float-left" style="margin-top: -1px;">Tabel Rekap Hotel</h3>
            </div>
          </div>
        </div>
          ...
          <div class="tab-content tab-space">
            <div class="tab-pane active" id="menu1">
              <div class="container-fluid mt-3">
                <table id="tbl_hotel" class="table table-no-bordered table-hover table-striped" cellspacing="0"
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <input type="hidden" name="id_hotel" id="id_hotel">
              ...
              <h5 id="label_hotel" class="font-weight-bold mt-2"></h5>
              </div>
            </div>
            <div class="col-md-6 col-lg-6">
              <div class="input-group "> 
                <input type="text" class="form-control datepicker11" id="periode" data="1" name="periode" style="margin-top: -6px;" placeholder="Pilih Tanggal Periode" autocomplete="off">
              </div>
            </div>
          </div>
        </div>
