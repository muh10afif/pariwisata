        ...
        <div class="card-body">
          <div class="row">
            ...
            <input type="hidden" name="id_dtw" id="id_dtw">
              ...
              <h5 id="label_dtw" class="font-weight-bold mt-2">Nama DTW : <?= $nama_dtw ?></h5>
              </div>
            </div>
            <div class="col-md-6 col-lg-6">
              <div class="input-group "> 
      ...
      <div class="tab-content tab-space">
        <div class="tab-pane active" id="link1">
          <div class="container-fluid mt-3">
            <table id="tbl_wisnus_ad" class="table table-bordered table-hover table-striped" width="100%" style="width: 100%;" role="grid">
        ...
        <div class="tab-pane" id="link2">
          <div class="container-fluid mt-3">
          <table id="tbl_wisman_ad" class="table table-bordered table-hover table-striped" width="100%" style="width: 100%;" role="grid">
              <thead class="thead-light">
                <th class="text-center" width="30px;">No</th>
...
$(document).ready(function () {
	...
	// menampilkan data
  	function show_data() {
		...
		var periode = 'awal';
		var id 		= '<?php echo $id_dtw ?>';
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('Rekap/Dtw/get_wisnus_p_dtw') ?>",
