    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose">
                <h3 class="card-title mb-3">Detail rekap DTW, <?= ucwords($nama_kota) ?></h3>
            </div>

            <?php if ($id_sess_kota == 0) : ?>
                <a href="<?= base_url('Rekap/Dtw') ?>" class="btn btn-warning btn-fab btn-round ml-5" style="margin-top:-20px;z-index:9" rel="tooltip" data-original-title="Kembali"><i class="material-icons text-white">chevron_left</i></a>
            <?php endif; ?>
            ...
            <div class="card-body table-responsive">
                ...
                <form action="<?= base_url('Rekap/Dtw/tampil_lihat_detail') ?>" id="form-rekap-dtw" class="mb-5 p-20" method="POST" target="_blank" autocomplete="off" <?= ($bln_awal != '' && $bln_akhir != '') ? '' : 'hidden' ?>>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="jenis_wisatawan" id="jenis_wisatawan" required>
                                            ...
                                            <option value="rekap_wisnus_dtw">Nusantara</option>
                                            <option value="rekap_wisman_dtw">Mancanegara</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mt-1">
                            <button class="btn btn-sm btn-success mr-3" id="lihat_detail_dtw" type="submit">Lihat Detail</button>
                            <button class="btn btn-sm btn-dark" id="reset_rekap_dtw" type="button">Reset</button>
                        </div>
                    </div>
        ...
        <div class="card table-responsive">
            <div class="card-body">
                <div class="tabel-rekap">
                    <table id="tabel_rekap_dtw" class="table table-light table-striped table-hover table-bordered" width="100%">
