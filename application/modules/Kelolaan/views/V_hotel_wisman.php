...
<div class="card">
    <form method="POST" id="form_wisman_hotel">
    ...
    <div class="card-body table-responsive">
        ...
        <div class="container-fluid mt-3 table-responsive">
           <table class="table table-light table-bordered table-hover table-striped" id="tabel_list_input_wisman" width="100%">
...
<script>
    $(document).ready(function () {
        ...
        var tabel_list_input_wisman = $('#tabel_list_input_wisman').DataTable({
            ...
            // "dom"           : "t",
            "ajax"          : {
                "url"   : "<?=base_url("Kelolaan/Hotel/tampil_list_hotel_wisman")?>",
                "type"  : "POST",
                "data"  : function (data) {
        ...
        $('#kawasan').change(function () {
            ...
            $.ajax({
                url         : "<?= base_url('Kelolaan/Hotel/ambil_negara') ?>",
                type        : "POST",
        ...
        $('#tabel_list_input_wisman').on('click', '.ubah-hotel-wisman', function () {
            ...
            $.ajax({
                url     : "<?= base_url('Kelolaan/Hotel/tampil_data_ubah_hotel_wisman') ?>",
                type    : "POST",
                beforeSend  : function () {
                    swal({
                        title   : 'Menunggu',
        ...
        $('#tabel_list_input_wisman').on('click', '.hapus-hotel-wisman', function () {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url     : "<?= base_url('Kelolaan/Hotel/simpan_ubah_hapus_list_wisman') ?>",
                        type    : "POST",
                        beforeSend  : function () {
                            swal({
                                title   : 'Menunggu',
        ...
        $('#simpan_list_wisman_hotel').on('click', function () {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url     : "<?= base_url('Kelolaan/Hotel/simpan_list_wisman_hotel') ?>",
                        type    : "POST",
                        beforeSend  : function () {
                            swal({
                                title   : 'Menunggu',
        ...
        $('#tambah_hotel_wisman').on('click', function () {
            ...
            if (periode == '') {
                ...
                // cek negara
                $.ajax({
                    url     : "<?= base_url('Kelolaan/Hotel/cek_negara') ?>",
                    type    : "POST",
                    beforeSend  : function () {
                        swal({
                            title   : 'Menunggu',
                    ...
                    success : function (data) {
                        ...
                        if (data.cek == 0) {
                            ...
                            $.ajax({
                                url     : "<?= base_url('Kelolaan/Hotel/simpan_list_wisman') ?>",
                                type    : "POST",
                                beforeSend  : function () {
                                    swal({
                                        title   : 'Menunggu',
        ...
        $('#periode_h_wisman').on('change', function () {
            ...
            $.ajax({
                ...
                data    : {periode:periode, id_hotel:id_hotel, data:data},
                dataType: "JSON",
                success : function (data) {
                    swal.close();
