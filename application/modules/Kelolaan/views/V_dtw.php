              ...
              <div class="row">
                ...
                <div class="col-md-4 col-lg-4">
                  <div class="input-group ">
                    ...
                    <input type="text" class="form-control datepicker11" id="periode_dtw" data="1" name="periode" style="margin-top: -6px;" placeholder="Pilih Bulan" autocomplete="off" value="<?= $per_awal ?>">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="tab-content tab-space">
            <div class="tab-pane active" id="menu1">
              <div class="container-fluid mt-3">
                <table id="tbl_dtw" class="table table-bordered table-hover table-striped" cellspacing="0"
                  width="100%" style="width: 100%;" role="grid">
                  <thead class="thead-light">
                    <th class="text-center" width="30px;">No</th>
                    <th class="text-center" width="250px;">Nama DTW</th>
        ...
        <div class="card-body" id="tab-wisnus"> 
          <div class="row">
            <div class="col-md-6 col-lg-6">
              ...
              <div class="input-group ">
              <h5 class="font-weight-bold label_dtw"><h5 class="font-weight-bold">
              </div>
            </div>
            <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <select name="provinsi" id="provinsi" class="form-control sel2">
                        <?php foreach ($provinsi as $p): ?>
                            <option value="<?= $p->id_provinsi ?>" data="<?= $p->nama_provinsi ?>"><?= $p->nama_provinsi ?></option>
                        <?php endforeach; ?>
                    </select>
    ...
    <div class="card-body">
      <div class="tab-content tab-space">
        <div class="tab-pane active" id="link1">
          <div class="container-fluid mt-3">
            <table id="tabel_list_input_wisnus" class="table table-no-bordered table-hover table-striped" style="width: 100%;">
               <thead class="thead-light">
                  <tr>
                      <th>No</th>
                      <th>Provinsi</th>
...
<script src="<?= base_url('assets/js/ajax/kelolaan/dtw.js') ?>"></script>
